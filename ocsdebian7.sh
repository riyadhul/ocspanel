...
wget -O /etc/nginx/nginx.conf "https://raw.github.com/riyadhul/ocspanel/master/nginx.conf"
wget -O /etc/nginx/conf.d/vps.conf "https://raw.github.com/riyadhul/ocspanel/master/vps.conf"
